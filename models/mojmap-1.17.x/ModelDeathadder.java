...
public class ModelDeathadder<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "deathadder"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-1.0F, 0.0F, -4.2857F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(20, 6)
		...
		PartDefinition group1 = partdefinition.addOrReplaceChild("group1",
				CubeListBuilder.create().texOffs(18, 13)
						.addBox(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(6, 17)
						...
						.addBox(-1.0F, -1.0F, 14.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(6, 13)
						.addBox(-1.0F, -1.0F, 16.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition group2 = partdefinition.addOrReplaceChild("group2",
				CubeListBuilder.create().texOffs(12, 11)
						.addBox(-1.0F, -1.0F, -14.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(12, 11)
		...
		PartDefinition tail = partdefinition.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(18, 17).addBox(
				-1.0F, -1.0F, 0.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 20.0F));
