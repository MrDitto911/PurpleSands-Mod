...
public class OrbCrafterGuiScreen extends AbstractContainerScreen<OrbCrafterGuiMenu> {
	...
	public OrbCrafterGuiScreen(OrbCrafterGuiMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("purple_sands:textures/orb_crafter_gui.png");
