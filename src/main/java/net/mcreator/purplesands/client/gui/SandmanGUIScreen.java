...
public class SandmanGUIScreen extends AbstractContainerScreen<SandmanGUIMenu> {
	...
	public SandmanGUIScreen(SandmanGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("purple_sands:textures/sandman_gui.png");
