...
public class Modelscorpionhusk<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("purple_sands", "modelscorpionhusk"), "main");
	public final ModelPart body;
	public final ModelPart legRB;
	public final ModelPart legRM;
	public final ModelPart legRF;
	public final ModelPart legLB;
	public final ModelPart legLM;
	public final ModelPart legLF;
	public final ModelPart Tail;
	public final ModelPart ClayL;
	public final ModelPart ClayR;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 0).addBox(-9.0F, -14.0F, -20.0F, 18.0F, 5.0F, 40.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition legRB = partdefinition.addOrReplaceChild("legRB", CubeListBuilder.create(), PartPose.offset(-7.6174F, 13.434F, 13.212F));
		PartDefinition cube_r1 = legRB.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(99, 70).addBox(-5.5F, -1.5F, -1.5F, 11.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r2 = legRB.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(13, 99).addBox(-2.0F, -1.0F, -1.0F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r3 = legRB.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(101, 53).addBox(-14.25F, -1.0F, -1.0F, 13.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r4 = legRB.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(0, 80).addBox(-6.5F, -1.5F, -1.5F, 13.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r5 = legRM.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(55, 98).addBox(-9.1113F, -0.7401F, 1.8736F, 11.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r6 = legRM.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(0, 99).addBox(-4.7394F, 2.0F, 2.5701F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r7 = legRM.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(84, 98).addBox(-18.1585F, -0.1342F, 1.9957F, 13.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r8 = legRM.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(63, 79).addBox(-6.4966F, 3.4589F, -0.8604F, 13.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r9 = legRF.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(26, 96).addBox(-10.8137F, -1.6219F, 5.4282F, 11.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r10 = legRF.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(59, 86).addBox(-6.8754F, 2.5F, 5.9628F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r11 = legRF.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(96, 79).addBox(-19.6307F, 1.0706F, 5.5582F, 13.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r12 = legRF.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(77, 28).addBox(-8.2994F, 6.8078F, 0.4983F, 13.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-4.495F, -7.684F, -3.192F, 1.4873F, 0.6725F, 1.3616F));
		PartDefinition legLB = partdefinition.addOrReplaceChild("legLB", CubeListBuilder.create(), PartPose.offset(8.6174F, 13.434F, 13.212F));
		PartDefinition cube_r13 = legLB.addOrReplaceChild("cube_r13",
				CubeListBuilder.create().texOffs(0, 92).addBox(-5.5F, -1.5F, -1.5F, 11.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r14 = legLB.addOrReplaceChild("cube_r14",
				CubeListBuilder.create().texOffs(54, 64).addBox(-2.0F, -1.0F, -1.0F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r15 = legLB.addOrReplaceChild("cube_r15",
				CubeListBuilder.create().texOffs(92, 93).addBox(1.25F, -1.0F, -1.0F, 13.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r16 = legLB.addOrReplaceChild("cube_r16",
				CubeListBuilder.create().texOffs(77, 21).addBox(-6.5F, -1.5F, -1.5F, 13.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r17 = legLM.addOrReplaceChild("cube_r17",
				CubeListBuilder.create().texOffs(91, 58).addBox(-1.8887F, -0.7401F, 1.8736F, 11.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r18 = legLM.addOrReplaceChild("cube_r18",
				CubeListBuilder.create().texOffs(21, 21).addBox(0.7394F, 2.0F, 2.5701F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r19 = legLM.addOrReplaceChild("cube_r19",
				CubeListBuilder.create().texOffs(91, 65).addBox(5.1585F, -0.1342F, 1.9957F, 13.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r20 = legLM.addOrReplaceChild("cube_r20",
				CubeListBuilder.create().texOffs(77, 14).addBox(-6.5034F, 3.4589F, -0.8604F, 13.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r21 = legLF.addOrReplaceChild("cube_r21",
				CubeListBuilder.create().texOffs(84, 86).addBox(-0.1863F, -1.6219F, 5.4282F, 11.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r22 = legLF.addOrReplaceChild("cube_r22",
				CubeListBuilder.create().texOffs(21, 16).addBox(2.8754F, 2.5F, 5.9628F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r23 = legLF.addOrReplaceChild("cube_r23",
				CubeListBuilder.create().texOffs(77, 35).addBox(6.6307F, 1.0706F, 5.5582F, 13.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r24 = legLF.addOrReplaceChild("cube_r24",
				CubeListBuilder.create().texOffs(77, 7).addBox(-4.7006F, 6.8078F, 0.4983F, 13.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.5291F, -7.684F, -3.4508F, 1.4873F, -0.6725F, -1.3616F));
		PartDefinition Tail = partdefinition.addOrReplaceChild("Tail",
				CubeListBuilder.create().texOffs(0, 32).addBox(-8.0F, -13.0F, 20.0F, 16.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(70, 53)
		...
		PartDefinition cube_r25 = Tail.addOrReplaceChild("cube_r25",
				CubeListBuilder.create().texOffs(25, 80).addBox(-2.0F, -1.5F, -3.0F, 4.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r26 = Tail.addOrReplaceChild("cube_r26",
				CubeListBuilder.create().texOffs(42, 84).addBox(-2.0F, -1.5F, -3.0F, 4.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r27 = Tail.addOrReplaceChild("cube_r27",
				CubeListBuilder.create().texOffs(67, 86).addBox(-2.0F, -1.5F, -3.0F, 4.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r28 = Tail.addOrReplaceChild("cube_r28",
				CubeListBuilder.create().texOffs(29, 46).addBox(-2.0F, -1.5F, -3.0F, 4.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -16.2522F, 30.2042F, 1.0472F, 0.0F, 0.0F));
		PartDefinition cube_r29 = Tail.addOrReplaceChild("cube_r29",
				CubeListBuilder.create().texOffs(21, 64).addBox(-2.0F, -2.0F, 2.0F, 4.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -10.0F, 22.5F, 0.48F, 0.0F, 0.0F));
		PartDefinition ClayL = partdefinition.addOrReplaceChild("ClayL",
				CubeListBuilder.create().texOffs(41, 46).addBox(10.1875F, -3.75F, -18.125F, 8.0F, 5.0F, 12.0F, new CubeDeformation(0.0F))
						.texOffs(33, 64).addBox(17.1875F, -2.75F, -26.125F, 4.0F, 3.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(0, 64)
		...
		PartDefinition cube_r30 = ClayL.addOrReplaceChild("cube_r30",
				CubeListBuilder.create().texOffs(77, 0).addBox(-7.0F, -1.5F, -1.5F, 14.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.4375F, -0.25F, -3.625F, 0.0F, 0.6109F, -0.0873F));
		PartDefinition ClayR = partdefinition.addOrReplaceChild("ClayR",
				CubeListBuilder.create().texOffs(0, 46).addBox(-18.1875F, -3.75F, -18.125F, 8.0F, 5.0F, 12.0F, new CubeDeformation(0.0F))
						.texOffs(0, 16).addBox(-21.1875F, -2.75F, -26.125F, 4.0F, 3.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition cube_r31 = ClayR.addOrReplaceChild("cube_r31",
				CubeListBuilder.create().texOffs(70, 46).addBox(-7.0F, -1.5F, -1.5F, 14.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.4375F, -0.25F, -3.625F, 0.0F, -0.6109F, 0.0873F));
