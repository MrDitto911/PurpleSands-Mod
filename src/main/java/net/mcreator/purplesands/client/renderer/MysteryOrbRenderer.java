...
public class MysteryOrbRenderer extends EntityRenderer<MysteryOrbEntity> {
	...
	public MysteryOrbRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new ModelMagicProjectile(context.bakeLayer(ModelMagicProjectile.LAYER_LOCATION));
	}

	@Override
	public void render(MysteryOrbEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn,
			int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(MysteryOrbEntity entity) {
		return texture;
	}
}
