...
public class BasicOrbRenderer extends EntityRenderer<BasicOrbEntity> {
	...
	public BasicOrbRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new ModelMagicProjectile(context.bakeLayer(ModelMagicProjectile.LAYER_LOCATION));
	}

	@Override
	public void render(BasicOrbEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn,
			int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(BasicOrbEntity entity) {
		return texture;
	}
}
