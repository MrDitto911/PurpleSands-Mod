...
public class ScorpionHuskEntity extends Monster {
	...
	public ScorpionHuskEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PurpleSandsModEntities.SCORPION_HUSK.get(), world);
	}

	public ScorpionHuskEntity(EntityType<ScorpionHuskEntity> type, Level world) {
		super(type, world);
		xpReward = 100;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(PurpleSandsModItems.SCORPION_DAGGER.get()));
	}
