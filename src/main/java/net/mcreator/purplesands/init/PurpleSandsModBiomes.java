...
public class PurpleSandsModBiomes {
	...
	public static Biome PURPLE_DESERT = register("purple_desert", PurpleDesertBiome.createBiome());

	private static Biome register(String registryname, Biome biome) {
		REGISTRY.add(biome.setRegistryName(new ResourceLocation(PurpleSandsMod.MODID, registryname)));
		return biome;
	}
