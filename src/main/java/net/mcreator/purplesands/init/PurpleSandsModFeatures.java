...
public class PurpleSandsModFeatures {
	...
	static {
		REGISTRY.put(PetrifiedLogFeature.FEATURE, new FeatureRegistration(GenerationStep.Decoration.UNDERGROUND_ORES,
				PetrifiedLogFeature.GENERATE_BIOMES, PetrifiedLogFeature.CONFIGURED_FEATURE));
		REGISTRY.put(PurpleOreFeature.FEATURE, new FeatureRegistration(GenerationStep.Decoration.UNDERGROUND_ORES, PurpleOreFeature.GENERATE_BIOMES,
