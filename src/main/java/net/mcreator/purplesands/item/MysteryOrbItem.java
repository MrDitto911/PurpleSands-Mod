...
import net.mcreator.purplesands.procedures.MysteryOrbRangedItemUsedProcedure;
...
public class MysteryOrbItem extends Item {
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				MysteryOrbEntity entityarrow = MysteryOrbEntity.shoot(world, entity, world.getRandom(), 0.5f, 0.1, 5);
				itemstack.hurtAndBreak(1, entity, e -> e.broadcastBreakEvent(entity.getUsedItemHand()));
				entityarrow.pickup = AbstractArrow.Pickup.DISALLOWED;

				MysteryOrbRangedItemUsedProcedure.execute(entity);
			}
		}
	}
}
