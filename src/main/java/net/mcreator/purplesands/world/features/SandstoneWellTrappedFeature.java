...
public class SandstoneWellTrappedFeature extends Feature<NoneFeatureConfiguration> {
	public static final SandstoneWellTrappedFeature FEATURE = (SandstoneWellTrappedFeature) new SandstoneWellTrappedFeature()
			.setRegistryName("purple_sands:sandstone_well_trapped");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE.configured(FeatureConfiguration.NONE);
	public static final Set<ResourceLocation> GENERATE_BIOMES = null;
	private StructureTemplate template = null;

	public SandstoneWellTrappedFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("purple_sands", "purple_well_trapped"));
		if (template == null)
			return false;
