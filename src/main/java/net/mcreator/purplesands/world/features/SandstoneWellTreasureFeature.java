...
public class SandstoneWellTreasureFeature extends Feature<NoneFeatureConfiguration> {
	public static final SandstoneWellTreasureFeature FEATURE = (SandstoneWellTreasureFeature) new SandstoneWellTreasureFeature()
			.setRegistryName("purple_sands:sandstone_well_treasure");
