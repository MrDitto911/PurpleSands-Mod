...
public class SandRefinerGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public SandRefinerGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(PurpleSandsModMenus.SAND_REFINER_GUI, id);
