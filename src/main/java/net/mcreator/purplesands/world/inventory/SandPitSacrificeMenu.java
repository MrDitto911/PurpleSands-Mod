...
public class SandPitSacrificeMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public SandPitSacrificeMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(PurpleSandsModMenus.SAND_PIT_SACRIFICE, id);
