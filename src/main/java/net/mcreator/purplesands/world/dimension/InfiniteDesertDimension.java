...
import net.mcreator.purplesands.procedures.InfiniteDesertPlayerEntersDimensionProcedure;
...
public class InfiniteDesertDimension {
		...
		public static void registerDimensionSpecialEffects(FMLClientSetupEvent event) {
			DimensionSpecialEffects customEffect = new DimensionSpecialEffects(Float.NaN, true, DimensionSpecialEffects.SkyType.NONE, false, false) {
				...
				public Vec3 getBrightnessDependentFogColor(Vec3 color, float sunHeight) {
					return new Vec3(0.498039215686, 0.145098039216, 1);
				}
			...
			event.enqueueWork(() -> DimensionSpecialEffects.EFFECTS.put(new ResourceLocation("purple_sands:infinite_desert"), customEffect));
		}
	}
	...
	public void onPlayerChangedDimensionEvent(PlayerEvent.PlayerChangedDimensionEvent event) {
		...
		if (event.getTo() == ResourceKey.create(Registry.DIMENSION_REGISTRY, new ResourceLocation("purple_sands:infinite_desert"))) {

			InfiniteDesertPlayerEntersDimensionProcedure.execute(entity);
		}
	}
}
